...
var (
	...
	evidence   = json.RawMessage(`{"verified":true,"benchmark_integrity":{"schema_version":1,"cases":[{"case_id":"case-1","warmup_invocations":0,"measured_invocations":1,"input_restores":1,"checked_invocations":1,"mismatches":0,"nonfinite":0,"canonical_input_mutations":0,"tolerance_passed":true}]}}`)
	validation = json.RawMessage(`{"guard":"passed","benchmark_integrity":{"schema_version":1,"cases":[{"case_id":"case-1","warmup_invocations":0,"measured_invocations":1,"input_restores":1,"checked_invocations":1,"mismatches":0,"nonfinite":0,"canonical_input_mutations":0,"tolerance_passed":true}]},"performance_claim":{"schema_version":1,"primary_speedup":1.1,"max_case_speedup":1.1}}`)
)
