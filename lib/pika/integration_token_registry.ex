defmodule Pika.IntegrationTokenRegistry do
  @moduledoc false
    ...
    case :ets.whereis(@table) do
      ...
      table ->
        case :ets.info(table, :owner) do
          ...
          owner ->
            {:error, {:integration_token_registry_owned, owner}}
        end
    end
  end
  ...
  def put(token, identity) when is_binary(token) and is_map(identity) do
    ...
    ArgumentError -> {:error, :integration_token_registry_not_started}
  end
